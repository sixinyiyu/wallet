...
wallet_sell = فروش
wallet_receive_collection = دریافت مجموعه
wallet_more = بیشتر
...
secret_phrase_save_phrase_safely = عبارات خصوصی خود را در مکانی امن ذخیره کنید.
...
simulation_warning_nft_collection_approval_title = دسترسی کامل به مجموعه NFT درخواست شد
...
camera_permission_request_camera = مجوز دوربین برای اسکن کد QR مورد نیاز است. لطفا اجازه بدهید.

# Notifications Permission

notifications_permission_request_notification = برای دریافت اعلان‌های مربوط به تراکنش‌های جدید، مجوز ارسال اعلان‌ها مورد نیاز است. لطفا اجازه بدهید.
