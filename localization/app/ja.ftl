...
common_loading = ローディング
common_address = アドレス
common_back = 戻る
common_try_again = もう一度やり直してください
common_paste = ペースト
common_delete = 消去
common_delete_confirmation = %@を削除してもよろしいですか?
common_hide = 隠れる
common_wallet = ウォレット
common_show = %@を表示
common_copied = コピー済み: %@
common_recommended = 推奨
common_all = 全て
common_not_available = 利用不可
common_phrase = フレーズ
common_manage = 管理
common_type = タイプ
common_no_results_found = 結果が見つかりません
common_yes = はい
common_no = いいえ
common_none = なし
common_url = メールアドレス
common_private_key = プライベートキー
common_latency_in_ms = %d ミリ秒
...
common_details = ディテール
common_info = 情報
common_get_started = 始める
common_earn = 稼ぐ
common_method = 方法
common_token = トークン
common_suspicious_address = 不審な住所
common_refresh = 更新
...
welcome_title = Gemファミリーへようこそ

# Wallet

wallet_create_new_wallet = 新しいウォレットを作成する
wallet_import_existing_wallet = 既存のウォレットをインポートする
wallet_send = 送る
wallet_receive = 受け取る
wallet_buy = 買う
wallet_swap = スワップ
wallet_import_title = ウォレットをインポート
wallet_new_title = 新しいウォレット
wallet_name = 名前
wallet_import_action = インポート
wallet_multicoin = マルチコイン
wallet_import_address_field = アドレスまたはドメイン
wallet_manage_token_list = トークンの管理
wallet_scan_qr_code = QRコードをスキャン
wallet_scan = スキャン
wallet_default_name = ウォレット #%d
wallet_default_name_chain = %@ ウォレット #%d
wallet_copy_address = アドレスをコピー
wallet_watch_tooltip_title = このウォレットを見ています。
wallet_stake = ステーク
wallet_receive_no_memo_required = メモ不要
wallet_receive_no_destination_tag_required = デスティネーション・タグ不要
wallet_title = ウォレット
wallet_add_token_title = トークンを追加
wallet_sell = 売却する
wallet_more = もっと見る
...
buy_title = %@を購入
buy_providers_title = プロバイダー
buy_rate = レート
buy_no_results = 見積もりなし
...
transfer_to = 宛て
transfer_max = マックス
transfer_network = ネットワーク
transfer_recipient_title = 受取人
transfer_balance = 残高: %@
transfer_title = 送金
...
transfer_redelegate_title = レデレゲート
...
transfer_sign_transaction_title = トランザクションに署名
...
settings_terms_of_services = 利用規約
settings_privacy_policy = プライバシーポリシー
settings_title = 設定
settings_developer = 開発者
settings_version = バージョン
settings_community = コミュニティ
settings_aboutus = 当社について
settings_networks_title = ネットワーク
...
settings_disable_value = %@を無効にする
settings_preferences_title = 設定
...
errors_error_occured = エラーが発生しました！
...
errors_swap_not_supported_chain = サポートされていないチェーン。
errors_swap_not_supported_asset = サポートされていないアセット。
errors_swap_not_supported_pair = サポートされていないペア。
...
errors_wallets_limit_title = ウォレットの上限に達しました
errors_wallets_limit_description = ウォレットの上限数（ %d ）に達しました。既存のウォレットを削除して、新しいウォレットを追加するか作成してください。
...
activity_state_empty_title = アクティビティはここに表示されます
activity_state_empty_description = 最初の取引を行う
activity_state_empty_search_description = フィルターをクリアしてアクティビティを更新する
activity_state_empty_search_title = アクティビティが見つかりません

# Update App

update_app_title = 新しいアップデートが利用可能です!
...
transaction_recipient = 受取人
transaction_sender = 送信者
transaction_date = 日付
transaction_view_on = %@で見る
transaction_status = 状態
transaction_status_confirmed = 成功
transaction_status_pending = 確認待ち
transaction_status_failed = 失敗した
transaction_status_reverted = 元に戻す
transaction_title_received = 受け
...
asset_balances = 残高
asset_balances_available = 利用可能
asset_price = 価格
asset_market_cap = 時価総額
asset_trading_volume = 取引量（24時間）
asset_market_cap_rank = 時価総額ランキング
asset_total_supply = 総供給量
asset_circulating_supply = 循環供給
asset_balances_reserved = 予約済み
asset_view_token_on = %@ でトーケンを見る
...
charts_all = 全て
charts_entry = エントリー
charts_price_open = 開ける
charts_price_close = 近い
...
wallet_connect_connection_title = 繋がり
wallet_connect_disconnect = 切断
wallet_connect_connect_title = 接続する
wallet_connect_app = アプリ
wallet_connect_website = Webサイト
wallet_connect_brand_name = WalletConnect
wallet_connect_no_active_connections = アクティブな接続はありません
wallet_connect_state_empty_description = コードをスキャンするか貼り付けて、DAppに接続してください
wallet_connect_domain = ドメイン
...
swap_price_impact_warning_description = この取引で%@のうち%@を失います。続行してもよろしいですか?
...
stake_active_in = アクティブ
stake_minimum_amount = 最小額
stake_viagem = Gem ウォレット経由でステークする
stake_no_active_staking = アクティブなステーキングはまだありません。
stake_state_empty_title = ステークはここに表示されます
stake_state_empty_description = 初めてステーキング %@
stake_resource = リソース
stake_resource_energy = エネルギー
stake_resource_bandwidth = 帯域
stake_delegations = 委任

# Assets

assets_no_assets_found = 資産なし
...
sign_message_title = メッセージを署名する
sign_message_message = メッセージ
sign_message_view_full_message = メッセージ全文を表示
...
social_website = Webサイト
social_opensea = オープンシー
social_magiceden = マジックエデン
social_instagram = インスタグラム
social_tiktok = ティックトック
social_coinmarketcap = コインマーケットキャップ

# Nodes

nodes_import_node_title = トークンを追加
nodes_import_node_chain_id = チェーンID
nodes_import_node_in_sync = 已同期
...
library_select_from_photo_library = 写真ライブラリから選択
...
filter_title = フィルター
filter_types = 種類
filter_has_balance = バランスがある

# Price Alerts

price_alerts_enabled_for = %@の価格アラートが有効になりました
price_alerts_disabled_for = %@の価格アラートは無効です
price_alerts_get_notified_explain_message = お気に入りの暗号資産の価格が大幅に変動したときに通知を受け取ります。
price_alerts_direction_over = オーバー
price_alerts_direction_under = アンダー
price_alerts_direction_increases_by = 増加分
...
lock_immediately = すぐに
lock_one_minute = 1 分
lock_five_minutes = 5 分
lock_fifteen_minutes = 15 分
lock_one_hour = 1 時間
lock_six_hours = 6 時間
lock_require_authentication = ロック時間
lock_unlock = ロック解除
...
info_slippage_description = スリッページとは、取引の予想価格と実際に約定した価格の差を指します。
...
info_insufficient_network_fee_balance_title = %@が必要です
info_insufficient_network_fee_balance_description = この取引には %@ ネットワーク料金を賄うために %@ 鉱夫ではなく Gem Wallet十分な量があることを確認してください %@。
info_insufficient_balance_title = 残高不足
info_insufficient_balance_description = この取引を完了するには%@が足りません。ウォレットにチャージ、受け取り、または交換して、もう一度お試しください。
...
info_perpetual_funding_rate_title = 資金調達率
info_perpetual_funding_rate_description = ファンディングレートは永久ポジションの保有コストを決定します。これは毎時計算され、永久契約と基礎資産のスポット価格の価格均衡を維持するのに役立ちます。
...
info_max_supply_title = 最大供給
info_max_supply_description = これまでに存在するコインの最大数。
info_perpetual_funding_apr_title = 年利の資金調達
...
permissions_access_denied = アクセスが拒否されました
permissions_image_photo_access_denied_description = このアプリには写真ライブラリにアクセスする権限がありません。デバイスの設定でアクセスを有効にしてください。
...
search_state_empty_description = スペルを確認するか、新しい検索を試してください。

# Networks

networks_state_empty_search_title = ネットワークが見つかりません
...
perpetual_positions = ポジション
perpetual_size = サイズ
perpetual_margin = マージン
perpetual_position = ポジション
perpetual_close_position = クローズポジション
perpetual_pnl = 損益
perpetual_long = ロング
perpetual_short = ショート
perpetual_entry_price = エントリー価格
perpetual_modify = 修正する
perpetual_reduce_position = 位置を減らす
perpetual_increase_position = ポジションを上げる
perpetual_open_direction = %@を開く
perpetual_close_direction = %@を閉じる
perpetual_leverage = てこの作用
perpetual_direction = 方向
perpetual_auto_close = 自動閉じる
perpetual_auto_close_take_profit = 利益確定
perpetual_market_price = 市場価格
perpetual_take_profit = TP
perpetual_stop_loss = SL
perpetual_liquidation = Liq
perpetual_increase_direction = %@を増やす
perpetual_reduce_direction = %@を減らす
perpetual_auto_close_expected_profit = 予想利益
perpetual_auto_close_expected_loss = 予想損失
perpetual_modify_position = 位置の変更
perpetual_auto_close_stop_loss = ストップロス
perpetual_value = 価値
...
perpetual_margin_isolated = 孤立した
...
recent_activity_title = 最近
recent_activity_state_empty_title = 最近のものがここに表示されます
recent_activity_state_empty_description = 最近使用したアセットがここに表示されます

# Notifications

notifications_inapp_state_empty_title = まだ通知はありません
notifications_inapp_state_empty_description = 通知に関する最新情報はここで確認できます
notifications_inapp_rewards_invite_subtitle = 友達を招待して一緒に報酬を獲得しましょう
