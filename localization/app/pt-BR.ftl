...
common_type = Tipo
common_no_results_found = Nenhum resultado encontrado
common_yes = Sim
common_no = Não
common_none = Nenhum
common_url = URL
...
wallet_create_new_wallet = Crie uma nova carteira
wallet_import_existing_wallet = Importe uma carteira existente
wallet_send = Enviar
...
transfer_sign_transaction_title = Assinar transação
...
errors_invalid_amount = Valor inválido
...
errors_error_occured = Ocorreu um erro!
...
errors_decoding_qr = Falha ao decodificar o código QR. Tente novamente com um código QR diferente.
errors_transfer_error = Erro de transferência
errors_unable_estimate_network_fee = No momento, não podemos calcular a taxa de rede.
...
errors_wallets_limit_title = Limite de carteiras atingido
errors_wallets_limit_description = Você atingiu o número máximo de carteiras permitidas ( %d ). Remova uma carteira existente para adicionar ou criar uma nova.
...
transaction_recipient = Destinatário
...
asset_balances_available = Disponível
asset_price = Preço
asset_market_cap = Valor de mercado
asset_trading_volume = Volume de Negociação (24h)
asset_market_cap_rank = Classificação de capitalização de mercado
...
asset_all_time_low = Mínima histórica
...
charts_price_low = Baixo
charts_price_change = Mudar
...
secret_phrase_do_not_share_title = Não compartilhe sua frase secreta!
secret_phrase_do_not_share_description = Se alguém tiver sua frase secreta, terá controle total de sua carteira!
secret_phrase_save_phrase_safely = Salve sua frase secreta em um local seguro\n que só você controla.
secret_phrase_confirm_quick_test_title = Conclua este teste rápido para confirmar que você salvou tudo corretamente.
secret_phrase_screenshot_detected_title = Captura de tela detectada
secret_phrase_screenshot_detected_description = Capturas de tela podem ser acessíveis a outros aplicativos e, se salvas dessa forma, podem colocar sua frase secreta em risco.
secret_phrase_content_hidden_description = Conteúdo oculto durante a gravação de tela
...
nodes_import_node_warning_message = Nós personalizados podem ser maliciosos e expor seus dados de transação ou fornecer informações falsas.

# Library

library_select_from_photo_library = Selecionar na biblioteca de fotos
...
price_alerts_set_alert_price_under = Quando o preço está abaixo
price_alerts_set_alert_price_increases_by = Quando o preço aumenta em
...
info_circulating_supply_description = O número de moedas atualmente disponíveis e negociadas no mercado.
...
nft_properties = Propriedades
nft_collections = Coleções
...
permissions_access_denied = Acesso negado
permissions_image_photo_access_denied_description = Este aplicativo não tem permissão para acessar sua biblioteca de fotos. Habilite o acesso nas configurações do seu dispositivo.
...
search_state_empty_description = Verifique a ortografia ou tente uma nova pesquisa.

# Networks

networks_state_empty_search_title = Nenhuma rede encontrada
...
onboarding_security_create_wallet_no_recovery_subtitle = Se você perder sua frase secreta, perderá o acesso à sua carteira.
onboarding_security_create_wallet_keep_safe_title = Guarde em algum lugar seguro
onboarding_security_create_wallet_no_recovery_title = Não podemos ajudar você a recuperá-lo
onboarding_accept_terms_title = Aceitar Termos
...
perpetual_increase_position = Aumentar a posição
perpetual_open_direction = Abrir %@
perpetual_close_direction = Fechar %@
perpetual_leverage = Alavancagem
perpetual_direction = Direção
perpetual_auto_close = Fechamento automático
perpetual_auto_close_take_profit = Obter lucro
perpetual_market_price = Preço de mercado
perpetual_take_profit = TP
perpetual_stop_loss = SL
perpetual_liquidation = Liq
perpetual_increase_direction = Aumentar %@
perpetual_reduce_direction = Reduzir %@
...
rewards_share_text = Juntar Gem Wallet Use meu link de indicação e ganhe recompensas: %@
rewards_my_referral_code = Meu código de indicação
...
rewards_activate_referral_code_title = Resgatar código
rewards_create_referral_code_title = Criar nome de usuário
...
rewards_pending_description = Disponível em %@
rewards_pending_description_ready = Seu bônus está pronto!
...
notifications_inapp_state_empty_title = Ainda não há notificações.
notifications_inapp_state_empty_description = Você verá atualizações sobre suas notificações aqui.
notifications_inapp_rewards_invite_subtitle = Convide amigos e ganhem recompensas juntos.

# Earn

earn_state_empty_title = Suas posições aparecerão aqui.
earn_state_empty_description = Faça seu primeiro depósito %@
