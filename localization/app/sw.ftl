...
wallet_buy = Nunua
wallet_swap = Badilisha
wallet_import_title = Ingiza Pochi
...
errors_wallets_limit_title = Kikomo cha Wallet Kimefikiwa
errors_wallets_limit_description = Umefikia idadi ya juu zaidi ya pochi inayoruhusiwa ( %d ). Tafadhali ondoa pochi iliyopo ili kuongeza au kuunda mpya.
errors_scan_transaction_malicious_title = Shughuli ya kutiliwa shaka
errors_connections_malicious_origin = Muunganisho huu unatoka kwa chanzo kisichoaminika.
errors_no_data_available = Hakuna data inayopatikana
errors_dust_threshold_short = Mtandao unazingatia kiasi hiki cha vumbi - ada ni kubwa kuliko kiasi yenyewe.
...
asset_verification_verified = Imethibitishwa
asset_all_time_high = Wakati Wote Juu
asset_all_time_low = Chini Wakati Wote
...
charts_price_low = Chini
charts_price_change = Badilisha
...
price_alerts_set_alert_price_under = Wakati bei iko chini
price_alerts_set_alert_price_increases_by = Wakati bei inaongezeka kwa
...
price_alerts_auto_footer = Arifa huanzisha hatua muhimu za bei.
...
info_insufficient_network_fee_balance_title = %@ inahitajika
info_insufficient_network_fee_balance_description = Muamala huu unahitaji %@ ili kufidia ada ya mtandao iliyolipwa kwa %@ wachimbaji, si Gem WalletHakikisha una vya kutosha %@.
...
info_perpetual_auto_close_description = Funga msimamo wako kiotomatiki katika viwango vya bei vilivyowekwa. Chukua kufuli za Faida katika faida, Stop Loss mipaka hasara.
...
info_circulating_supply_description = Idadi ya sarafu zinazopatikana sasa na zinazouzwa sokoni.
...
search_state_empty_description = Angalia tahajia au jaribu utafutaji mpya.

# Networks

networks_state_empty_search_title = Hakuna mitandao iliyopatikana
...
perpetual_positions = Vyeo
perpetual_size = Ukubwa
perpetual_margin = Pembezoni
...
perpetual_increase_position = Ongeza Nafasi
perpetual_open_direction = Fungua %@
perpetual_close_direction = Funga %@
perpetual_leverage = Uvunjaji wa kifedh
...
perpetual_increase_direction = Ongeza %@
perpetual_reduce_direction = Punguza %@
perpetual_auto_close_expected_profit = Faida inayotarajiwa
perpetual_auto_close_expected_loss = Hasara inayotarajiwa
perpetual_modify_position = Rekebisha Nafasi
perpetual_auto_close_stop_loss = Acha hasara
perpetual_value = Thamani
perpetual_unrealized_pnl = PnL Isiyotekelezwa
perpetual_volume = Kiasi
...
rewards_title = Zawadi
rewards_share_text = Jiunge Gem Wallet kwa kutumia kiungo changu cha rufaa na upate zawadi: %@
rewards_my_referral_code = Nambari yangu ya rufaa
...
rewards_get_rewards_title = Pata Zawadi
rewards_activate_referral_code_description = Una nambari ya rufaa kutoka kwa rafiki?
rewards_activate_referral_code_title = Komboa msimbo
rewards_create_referral_code_title = Unda Jina la Mtumiaji
rewards_create_referral_code_info = Hili litakuwa jina lako la utani la pochi ya sasa.
rewards_username = Jina la mtumiaji
rewards_ways_spend_title = Njia za Kutumia
rewards_ways_spend_asset_title = Pata %@
rewards_insufficient_points = Pointi zisizotosha
rewards_confirm_redeem = Pata %@ kwa %@!
rewards_pending_title = Bonasi Inasubiri
rewards_pending_description = Inapatikana katika %@
rewards_pending_description_ready = Bonasi yako iko tayari!
...
earn_state_empty_title = Nafasi zako zitaonekana hapa
earn_state_empty_description = Weka pesa zako kwanza %@

# Contacts

contacts_title = Anwani
contacts_contact = Mawasiliano
