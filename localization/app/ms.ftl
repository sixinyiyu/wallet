...
wallet_buy = Beli
wallet_swap = Tukar
wallet_import_title = Dompet Import
...
wallet_withdraw = Tarik balik
wallet_available_balance = Tersedia: %@
wallet_portfolio_title = Portfolio
wallet_import_already_imported_message = Dompet ini telah pun diimport.
...
errors_wallets_limit_title = Had Dompet Dicapai
errors_wallets_limit_description = Anda telah mencapai bilangan maksimum dompet yang dibenarkan ( %d ). Sila alih keluar dompet sedia ada untuk menambah atau membuat yang baharu.
errors_scan_transaction_malicious_title = Aktiviti Meragukan
errors_connections_malicious_origin = Sambungan ini datang dari sumber yang tidak dipercayai.
errors_no_data_available = Tiada data tersedia
errors_dust_threshold_short = Rangkaian menganggap jumlah habuk ini - bayarannya lebih tinggi daripada jumlah itu sendiri.
...
asset_verification_verified = Disahkan
asset_all_time_high = Tertinggi Sepanjang Masa
asset_all_time_low = Rendah Sepanjang Masa
...
wallet_connect_permissions_view_balance = Lihat keseimbangan dan aktiviti anda
...
price_alerts_set_alert_price_under = Apabila harga di bawah
price_alerts_set_alert_price_increases_by = Apabila harga meningkat sebanyak
price_alerts_set_alert_price_decreases_by = Apabila harga menurun sebanyak
...
info_insufficient_network_fee_balance_description = Transaksi ini memerlukan %@ untuk menampung yuran rangkaian yang dibayar kepada %@ pelombong, bukan Gem WalletPastikan anda mempunyai cukup %@.
...
info_circulating_supply_description = Bilangan syiling yang kini tersedia dan didagangkan di pasaran.
...
search_state_empty_description = Semak ejaan atau cuba carian baharu.

# Networks

networks_state_empty_search_title = Tiada rangkaian ditemui
...
perpetual_increase_position = Tingkatkan Kedudukan
...
perpetual_increase_direction = Tingkatkan %@
perpetual_reduce_direction = Kurangkan %@
perpetual_auto_close_expected_profit = Keuntungan yang dijangkakan
perpetual_auto_close_expected_loss = Kerugian yang dijangkakan
perpetual_modify_position = Ubahsuai Kedudukan
perpetual_auto_close_stop_loss = Hentikan kerugian
perpetual_value = Nilai
perpetual_unrealized_pnl = PnL Tidak Terrealisasi
perpetual_volume = Kelantangan
...
rewards_share_text = Sertai Gem Wallet dengan pautan rujukan saya dan dapatkan ganjaran: %@
rewards_my_referral_code = Kod rujukan saya
...
rewards_get_rewards_title = Dapatkan Ganjaran
rewards_activate_referral_code_description = Ada kod rujukan daripada rakan?
rewards_activate_referral_code_title = Tebus kod
rewards_create_referral_code_title = Cipta Nama Pengguna
rewards_create_referral_code_info = Ini akan menjadi nama panggilan peribadi anda untuk dompet semasa.
rewards_username = Nama pengguna
rewards_ways_spend_title = Cara-cara untuk Berbelanja
rewards_ways_spend_asset_title = Dapatkan %@
rewards_insufficient_points = Mata tidak mencukupi
rewards_confirm_redeem = Dapatkan %@ untuk %@!
...
earn_state_empty_title = Kedudukan anda akan dipaparkan di sini
earn_state_empty_description = Depositkan yang pertama %@

# Contacts

contacts_title = Kenalan
contacts_contact = Hubungi
