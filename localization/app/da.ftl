...
wallet_buy = Købe
wallet_swap = Byt
wallet_import_title = Importér tegnebog
...
errors_wallets_limit_title = Grænsen for tegnebøger er nået
errors_wallets_limit_description = Du har nået det maksimale antal tilladte tegnebøger ( %d ). Fjern venligst en eksisterende tegnebog for at tilføje eller oprette en ny.
errors_scan_transaction_malicious_title = Mistænkelig aktivitet
errors_connections_malicious_origin = Denne forbindelse kommer fra en upålidelig kilde.
errors_no_data_available = Ingen data tilgængelige
errors_dust_threshold_short = Netværket anser denne mængde for støv – gebyret er højere end selve mængden.
...
asset_verification_verified = Bekræftet
asset_all_time_high = Alle tiders højder
asset_all_time_low = Laveste niveau nogensinde
...
charts_price_low = Lav
charts_price_change = Forandring
...
stake_delegations = Delegationer
...
price_alerts_direction_decreases_by = Falder med
price_alerts_set_alert_price_over = Når prisen er overstået
price_alerts_set_alert_price_under = Når prisen er under
price_alerts_set_alert_price_increases_by = Når prisen stiger med
price_alerts_set_alert_price_decreases_by = Når prisen falder med
...
info_insufficient_network_fee_balance_title = %@ påkrævet
info_insufficient_network_fee_balance_description = Denne transaktion kræver %@ til dækning af det betalte netværksgebyr %@ minearbejdere, ikke Gem WalletSørg for at du har nok %@.
...
info_circulating_supply_description = Antallet af tilgængelige og handlede mønter på markedet i øjeblikket.
...
search_state_empty_description = Tjek stavningen eller prøv en ny søgning.

# Networks

networks_state_empty_search_title = Ingen netværk fundet
...
perpetual_increase_position = Øg position
...
perpetual_increase_direction = Forøgelse %@
perpetual_reduce_direction = Reducer %@
perpetual_auto_close_expected_profit = Forventet fortjeneste
perpetual_auto_close_expected_loss = Forventet tab
perpetual_modify_position = Rediger position
perpetual_auto_close_stop_loss = Stop-loss
perpetual_value = Værdi
perpetual_unrealized_pnl = Urealiseret PnL
perpetual_volume = Bind
...
rewards_share_text = Deltag Gem Wallet med mit henvisningslink og optjen belønninger: %@
rewards_my_referral_code = Min henvisningskode
...
rewards_get_rewards_title = Få belønninger
rewards_activate_referral_code_description = Har du en henvisningskode fra en ven?
rewards_activate_referral_code_title = Indløs kode
rewards_create_referral_code_title = Opret brugernavn
rewards_create_referral_code_info = Dette vil være dit personlige kaldenavn for den nuværende tegnebog.
rewards_username = Brugernavn
rewards_ways_spend_title = Måder at bruge penge på
rewards_ways_spend_asset_title = Få %@
rewards_insufficient_points = Utilstrækkelige point
rewards_confirm_redeem = Få %@ for %@!
rewards_pending_title = Bonus afventer
rewards_pending_description = Tilgængelig i %@
rewards_pending_description_ready = Din bonus er klar!
...
earn_state_empty_title = Dine stillinger vil blive vist her
earn_state_empty_description = Indbetal din første %@

# Contacts

contacts_title = Kontakter
contacts_contact = Kontakte
