...
static CHAIN_CONFIGS: LazyLock<Vec<ChainConfig>> = LazyLock::new(|| {
    vec![
        ...
        ChainConfig {
            ...
            denom: Some(CosmosChain::Thorchain.denom().as_ref().into()),
            slip44: 931,
        ...
        ChainConfig {
            ...
            network_id: "mayachain-mainnet-v1",
            denom: Some(CosmosChain::Mayachain.denom().as_ref().into()),
            slip44: 931,
            chain_type: ChainType::Cosmos,
            default_asset_type: None,
            account_activation_fee: None,
        ...
        ChainConfig {
            ...
            denom: Some(CosmosChain::Cosmos.denom().as_ref().into()),
            slip44: 118,
            chain_type: ChainType::Cosmos,
            default_asset_type: None,
            account_activation_fee: None,
        ...
        ChainConfig {
            ...
            denom: Some(CosmosChain::Osmosis.denom().as_ref().into()),
            slip44: 118,
            chain_type: ChainType::Cosmos,
            default_asset_type: None,
            account_activation_fee: None,
        ...
        ChainConfig {
            chain: Chain::Aptos,
            network_id: "1",
            denom: Some("0x1::aptos_coin::AptosCoin".into()),
            slip44: 637,
        ...
        ChainConfig {
            ...
            network_id: "celestia",
            denom: Some(CosmosChain::Celestia.denom().as_ref().into()),
            slip44: 118,
            chain_type: ChainType::Cosmos,
            default_asset_type: None,
            account_activation_fee: None,
        ...
        ChainConfig {
            ...
            denom: Some(CosmosChain::Injective.denom().as_ref().into()),
            slip44: 60,
            chain_type: ChainType::Cosmos,
            default_asset_type: None,
            account_activation_fee: None,
        ...
        ChainConfig {
            ...
            denom: Some(CosmosChain::Sei.denom().as_ref().into()),
            slip44: 118,
            chain_type: ChainType::Cosmos,
            default_asset_type: None,
            account_activation_fee: None,
        ...
        ChainConfig {
            ...
            evm: Some(EvmChainConfig {
                ...
                chain_stack: ChainStack::Native,
                is_ethereum_layer2: false,
                weth_contract: Some("0xE30feDd158A2e3b13e9badaeABaFc5516e95e8C7"),
            }),
            stake: None,
        },
        ChainConfig {
        ...
        ChainConfig {
            chain: Chain::Noble,
            network_id: "noble-1",
            denom: Some(CosmosChain::Noble.denom().as_ref().into()),
            slip44: 118,
            chain_type: ChainType::Cosmos,
            default_asset_type: None,
            account_activation_fee: None,
