...
pub enum ConfigKey {
    ...
    PriceTimerAssets,
    PriceTimerAssetsNew,
    PriceTimerAssetsMetadata,
    PriceTimerChartsHistory,
    PriceTimerCleanOutdated,
    PriceTimerCleanupChartsRaw,
    PriceTimerCleanupChartsHourly,
    PriceChartsRetentionRaw,
    PriceChartsRetentionHourly,
    ...
    TransactionTimerSwapVaultAddresses,
...
impl ConfigKey {
    ...
    pub fn default_value(&self) -> &'static str {
        match self {
            ...
            Self::PriceTimerAssets => "1d",
            Self::PriceTimerAssetsNew => "15m",
            Self::PriceTimerAssetsMetadata => "30d",
            Self::PriceTimerChartsHistory => "1d",
