use crate::{SignerError, SignerInput};

pub trait ChainSigner: Send + Sync {
    fn sign_transfer(&self, _input: &SignerInput, _private_key: &[u8]) -> Result<String, SignerError> {
        Err(SignerError::SigningError("sign_transfer not implemented".to_string()))
    }

    fn sign_token_transfer(&self, _input: &SignerInput, _private_key: &[u8]) -> Result<String, SignerError> {
    ...
    fn sign_token_approval(&self, _input: &SignerInput, _private_key: &[u8]) -> Result<String, SignerError> {
        Err(SignerError::SigningError("sign_token_approval not implemented".to_string()))
    }

    fn sign_stake(&self, _input: &SignerInput, _private_key: &[u8]) -> Result<Vec<String>, SignerError> {
        Err(SignerError::SigningError("sign_stake not implemented".to_string()))
    }

    fn sign_message(&self, _message: &[u8], _private_key: &[u8]) -> Result<String, SignerError> {
        Err(SignerError::SigningError("sign_message not implemented".to_string()))
    }

    fn sign_account_action(&self, _input: &SignerInput, _private_key: &[u8]) -> Result<String, SignerError> {
        Err(SignerError::SigningError("sign_account_action not implemented".to_string()))
    }

    fn sign_perpetual(&self, _input: &SignerInput, _private_key: &[u8]) -> Result<Vec<String>, SignerError> {
        Err(SignerError::SigningError("sign_perpetual not implemented".to_string()))
    }

    fn sign_withdrawal(&self, _input: &SignerInput, _private_key: &[u8]) -> Result<String, SignerError> {
